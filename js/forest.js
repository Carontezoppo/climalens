// Land cover globe — ESA WorldCover 10m 2020 · static texture, generated by
// scripts/build_landcover_texture.py from the free public AWS bucket (no live
// API, no per-request cost — see that script for why and how to regenerate).

const LANDCOVER_GLOBE_TEXTURE = 'img/worldcover-2020-globe-texture.png';
...
function initLandCoverGlobe() {
  ...
  landcoverGlobe = Globe()
    .globeImageUrl(LANDCOVER_GLOBE_TEXTURE)
  ...
  landcoverGlobe.pointOfView({ lat: 15, lng: 10, altitude: 1.5 });
